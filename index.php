...
<body>
    ...
    <main>
        <section class="centrage">
            <div id="lien">
                <a href="horloge.php"><button>Horloge</button></a>
                <a href="reveil.php"><button>Réveil</button></a>
                <a href="chronometre.php"><button>Chronomètre</button></a>
                <a href="minuteur.php"><button>Minuteur</button></a>
            </div>
        </section>
    </main>
